...
class PostalAgencies(Base):
    ...
    __table_args__ = (
        UniqueConstraint("name", "zip_code", name="unique_name_zip_code"),
    ...
    def to_dict(self):
        point_shape = to_shape(self.location) if self.location is not None else None

        point_wkt = point_shape.wkt if point_shape else None
