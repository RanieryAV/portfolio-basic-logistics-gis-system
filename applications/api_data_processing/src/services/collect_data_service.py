    ...
    def execute(self, batch_size: int = 100):
        ...
        try:
            ...
            possible_paths = [
                ...
                os.path.join(local_root, "shared", "utils", "datasets", "correios_al.geojson"), # Local execution
                os.path.join(local_root, "shared", "utils", "datasets", "correios_al.geojson.json") # Local execution (Fallback)
            ]
